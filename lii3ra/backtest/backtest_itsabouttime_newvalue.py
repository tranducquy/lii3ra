...
from donkatsu.entry_strategy.its_about_time import ItsAboutTime
...
def backtest_run(symbol
    ...
    try:
        ...
        open_title = f"ItsAboutTime[{lookback:.0f},{long_time},{short_time}]"
        close_title = f"NewValue"
        open_strategy = ItsAboutTime(open_title, ohlcv, lookback, long_time, short_time)
