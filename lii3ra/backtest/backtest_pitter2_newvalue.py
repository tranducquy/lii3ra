...
from donkatsu.entry_strategy.pitter_patter_pattern2 import PitterPatterPattern2
...
def backtest_run(symbol
    ...
    try:
        ...
        open_title = f"PitterPatterPattern2"
        close_title = f"NewValue"
        open_strategy = PitterPatterPattern2(open_title, ohlcv)
