...
from donkatsu.entry_strategy.two_amigos import TwoAmigos
...
def backtest_run(symbol
    ...
    try:
        ...
        open_title = f"TwoAmigos[{adx_span:.0f},{adx_threshold:.0f},,{lookback:.0f}]"
        close_title = f"NewValue"
        open_strategy = TwoAmigos(open_title, ohlcv, adx, adx_threshold, lookback)
