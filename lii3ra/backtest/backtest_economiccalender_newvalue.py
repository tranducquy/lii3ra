...
from donkatsu.entry_strategy.economic_calender import EconomicCalender
...
def backtest_run(symbol
    ...
    try:
        ...
        entry_title = f"EconomicCalender[{long_entry_dayofweek_title},{long_time}][{short_entry_dayofweek_title},{short_time}]"
        exit_title = "NewValue"
        entry_strategy = EconomicCalender(entry_title, ohlcv, long_weekday, long_time, short_weekday, short_time)
