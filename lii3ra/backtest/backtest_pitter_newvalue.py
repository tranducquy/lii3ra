...
from donkatsu.entry_strategy.pitter_patter_pattern import PitterPatterPattern
...
def backtest_run(symbol
    ...
    try:
        ...
        open_title = f"PitterPatterPattern"
        close_title = f"NewValue"
        open_strategy = PitterPatterPattern(open_title, ohlcv)
