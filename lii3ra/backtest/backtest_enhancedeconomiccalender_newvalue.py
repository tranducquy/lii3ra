...
from donkatsu.entry_strategy.enhanced_economic_calender import EnhancedEconomicCalender
...
def backtest_run(symbol
    ...
    try:
        ...
        long_entry_dayofweek_title = ",".join(map(str, long_weekday))
        short_entry_dayofweek_title = ",".join(map(str, short_weekday))
        entry_title = f"EnhancedEconomicCalender[{long_entry_dayofweek_title},{long_time}][{short_entry_dayofweek_title},{short_time}][{lookback:.0f}]"
        exit_title = "NewValue"
        entry_strategy = EnhancedEconomicCalender(entry_title, ohlcv, long_weekday, long_time, short_weekday, short_time, lookback)
