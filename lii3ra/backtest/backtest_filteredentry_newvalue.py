...
from donkatsu.entry_strategy.filtered_entry import FilteredEntry
...
def backtest_run(symbol
    ...
    try:
        ...
        open_title = f"FilteredEntry[{lookback:.0f}]"
        close_title = f"NewValue"
        open_strategy = FilteredEntry(open_title, ohlcv, lookback)
