...
from donkatsu.technical_indicator.ultimate_oscillator import UltimateOscillator
from donkatsu.entry_strategy.the_ultimate import TheUltimate
...
def backtest_run(symbol
    ...
    try:
        ...
        uo = UltimateOscillator(ohlcv, ultimate_avg1, ultimate_avg2, ultimate_avg3)
        open_title = f"TheUltimate[{lookback:.0f},{ultimate_avg1:.0f},{ultimate_avg2:.0f},{ultimate_avg3:.0f}]"
        close_title = f"NewValue"
        entry_strategy = TheUltimate(open_title, ohlcv, lookback, uo)
...
def backtest(symbol, ashi, start_date, end_date, brute_force=False):
    ...
    if brute_force:
        ...
        if symbol in params:
            ...
            ultimate_avg1 = params[symbol][1]
            ultimate_avg2 = params[symbol][2]
            ultimate_avg3 = params[symbol][3]
        backtest_run(symbol
                     , ashi
                     , start_date
                     , end_date
