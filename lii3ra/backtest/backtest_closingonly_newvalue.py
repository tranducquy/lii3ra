...
from donkatsu.entry_strategy.closing_pattern_only import ClosingPatternOnly
...
def backtest_run(symbol
    ...
    try:
        ...
        open_title = f"ClosingPatternOnly"
        close_title = f"NewValue"
        open_strategy = ClosingPatternOnly(open_title, ohlcv)
