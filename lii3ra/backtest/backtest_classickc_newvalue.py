...
from donkatsu.technical_indicator.keltner_channels import KeltnerChannels
from donkatsu.entry_strategy.classic_keltner_channel import ClassicKeltnerChannel
...
def backtest_run(symbol
    ...
    try:
        ...
        kc = KeltnerChannels(ohlcv, atr_span, kc_ratio)
        open_title = f"ClassicKC[{atr_span:.0f},{kc_ratio:.2f},{lookback:.0f}]"
        close_title = f"NewValue"
        open_strategy = ClassicKeltnerChannel(open_title, ohlcv, kc, kc_ratio, lookback)
