...
def backtest_open_breakout_sigma1_close_percentile(symbol
                                                , ashi
                                                , start_date
                                                , end_date
                                                , long_sma_span
    ...
    close_title = f"Percentile[{percentile_span}][{percentile_ratio_long:.0f}][{percentile_ratio_short:.0f}]"
    open_strategy = BreakoutBBSigma1Asym(open_title, ohlcv, long_bb, short_bb, vol_sma)
    close_strategy = Percentile(close_title, ohlcv, percentile_span, percentile_ratio_long, percentile_ratio_short, percentile_losscut_ratio)
...
def backtest(symbol, ashi, start_date, end_date, brute_force=False, long_flg=False, short_flg=False):
    ...
    if brute_force:
        ...
        vol_sma_span = 5
        short_sma_span = 4
        short_sigma1_ratio = 1.6
        percentile_span = 5
        percentile_ratio_long = 70
        percentile_ratio_short = 70
        percentile_losscut_ratio = 0.1
        #symbolごとのparameter
        if symbol in params:
            ...
            percentile_span = params[symbol][5]
            percentile_ratio_long = params[symbol][6]
            percentile_ratio_short = params[symbol][7]
        backtest_open_breakout_sigma1_close_percentile(symbol
                                                    , ashi
                                                    , start_date
                                                    , end_date
                                                    , long_sma_span
