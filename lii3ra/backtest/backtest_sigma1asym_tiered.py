...
from donkatsu.exit_strategy.tiered import Tiered
...
def backtest_open_breakout_bbsigma1_close_tiered(symbol
                                                        , ashi
                                                        , start_date
                                                        , end_date
                                                        , long_sma_span
    ...
    close_strategy = Tiered(close_title, ohlcv
                                        , long_profit_floor1
                                        , long_profit_ratio1
                                        , long_profit_floor2
                                        , long_profit_ratio2
...
def backtest(symbol, ashi, start_date, end_date, brute_force=False, long_flg=False, short_flg=False):
    ...
    if brute_force:
        ...
        long_profit_floor1 = 400
        long_profit_floor2 = 800
        long_profit_floor3 = 1200
        long_profit_ratio1 = 0.5
        long_profit_ratio2 = 0.75
        long_profit_ratio3 = 0.9
        short_profit_floor1 = 400
        short_profit_floor2 = 800
        short_profit_floor3 = 1200
        short_profit_ratio1 = 0.6
        short_profit_ratio2 = 0.75
        short_profit_ratio3 = 0.9
        #symbolごとのparameter
        if symbol in params:
        ...
        backtest_open_breakout_bbsigma1_close_tiered(symbol
                                                    , ashi
                                                    , start_date
                                                    , end_date
                                                    , long_sma_span
