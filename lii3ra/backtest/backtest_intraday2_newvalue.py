...
from donkatsu.entry_strategy.intraday_breakout_with_expanding_range import IntradayBreakoutWithExpandingRange
...
def backtest_run(symbol
    ...
    try:
        ...
        entry_title = f"IntradayBreakout2[{adx_span:.0f},{adx_threshold:.2f}][{begin_time},{end_time}]"
        exit_title = f"NewValue"
        entry_strategy = IntradayBreakoutWithExpandingRange(entry_title, ohlcv, adx, adx_threshold, begin_time, end_time)
