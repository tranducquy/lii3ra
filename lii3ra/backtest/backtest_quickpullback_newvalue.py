...
from donkatsu.entry_strategy.quick_pullback_pattern import QuickPullbackPattern
...
def backtest_run(symbol
    ...
    try:
        ...
        open_title = f"QuickPullbackPattern"
        close_title = f"NewValue"
        open_strategy = QuickPullbackPattern(open_title, ohlcv)
