...
from donkatsu.exit_strategy.end_of_bar import EndOfBar
...
def backtest_main(symbol
    ...
    entry_title = f"Sigma1Asym.{long_sma_duration:.0f}.{long_sigma1_ratio:.1f}.{short_sma_duration:.0f}.{short_sigma1_ratio:.1f}"
    exit_title = f"EndOfBar"
    entry_strategy = BreakoutBBSigma1Asym(entry_title, ohlcv, long_bb, short_bb, vol_sma)
    exit_strategy = EndOfBar(exit_title, ohlcv)
