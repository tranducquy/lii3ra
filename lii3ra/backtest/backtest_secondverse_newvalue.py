...
from donkatsu.entry_strategy.second_verse_same_as_the_first import SecondVerseSameAsTheFirst
...
def backtest_run(symbol
    ...
    try:
        ...
        open_title = f"SecondVerse"
        close_title = f"NewValue"
        open_strategy = SecondVerseSameAsTheFirst(open_title, ohlcv, threshold, lookback)
