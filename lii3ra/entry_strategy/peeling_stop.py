...
class PeelingStopFactory(EntryStrategyFactory):
    params = {
        # imethod, ma_span, long_peeling_ratio, short_peeling_ratio, atr_ratio
        "default": [1, 15, -0.15, 0.15, 0.25]
...
class PeelingStop(EntryStrategy):
    """
    移動平均乖離率でやっちゃう
    """
    ...
    def __init__(self
        ...
        self.atr = AverageTrueRange(ohlcv, span)
