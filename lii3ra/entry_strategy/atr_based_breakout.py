...
class ATRBasedBreakoutFactory(EntryStrategyFactory):
    params = {
        ...
        , "9107.T": [28, 0.3, 23, 0.3]  # NewValue
        # , "9107.T": [3, 0.3, 23, 0.3]  # End of Bar 2020120-
        , "9104.T": [13, 0.3, 28, 0.3]
        , "8306.T": [23, 0.9, 3, 1.2]
        , "5411.T": [18, 0.3, 1, 0.0]
        # , "Mothers": [8, 0.6, 8, 0.3]
        , "Mothers": [28, 0.3, 3, 0.3]  # End of Bar 20200120-
        , "2516.T": [28, 0.3, 3, 0.3]
        # , "1570.T": [13, 0.6, 18, 0.3]  # NewValue
        , "1570.T": [28, 0.3, 13, 0.3]  # End of Bar
        , "4043.T": [13, 0.3, 3, 0.3]  # End of Bar 20200121-
        , "3064.T": [18, 0.3, 28, 0.3]  # End of Bar 20200121-
        , "2267.T": [18, 0.3, 3, 0.3]  # End of Bar 20200121-
    }
        ...
        if not optimization:
            ...
            for long_span in long_spans:
                for long_ratio in long_ratios:
                    strategies.append(ATRBasedBreakout(ohlcv, long_span, long_ratio, 3, 100.0))
            for short_span in short_spans:
                for short_ratio in short_ratios:
                    strategies.append(ATRBasedBreakout(ohlcv, 3, 100.0, short_span, short_ratio))
            # for long_span in long_spans:
            #     for long_ratio in long_ratios:
            #         for short_span in short_spans:
            #             for short_ratio in short_ratios:
