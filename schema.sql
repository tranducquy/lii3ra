...
(
    ...
    order_type_oco1 integer,
    order_vol_oco1 double precision,
    order_price_oco1 double precision,
    order_type_oco2 integer,
    order_vol_oco2 double precision,
    order_price_oco2 double precision,
